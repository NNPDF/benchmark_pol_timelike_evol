...
{
  for (auto const& f : apfel::QCDEvToPhys(apfel::LHToyPDFsPol(x, Q)))
...
int main()
{
  ...
  const std::vector<std::string> fnamev{
    "../results/hoppet-table16-part2.csv",
    "../results/hoppet-table16-part3.csv",
    "../results/hoppet-table17-part1.csv",
    "../results/hoppet-table18-part1.csv",
      };
