...
c       DIMENSION PDFX(-6:6), MS(20), XB(22)
       DIMENSION PDFX(-6:6), MS(1), XB(11)
...
*
       DATA MS / 1.D4 /
c       DATA MS / 2.0D0,  2.7D0,  3.6D0,  5.D0,   7.D0,   1.D1,
c     1           1.4D1,  2.D1,   3.D1,   5.D1,   7.D1,   1.D2,
c     2           2.D2,   5.D2,   1.D3,   3.D3,   1.D4,   4.D4,
c     3           2.D5,   1.D6 /
*
c       DATA XB / 1.D-5,  2.D-5,  5.D-5,  1.D-4,  2.D-4,  5.D-4,
c     1           1.D-3,  2.D-3,  5.D-3,  1.D-2,  2.D-2,  5.D-2,
c     2           1.D-1, 1.5D-1,  2.D-1,  3.D-1,  4.D-1,  5.D-1,
c     3           6.D-1,  7.D-1,  8.D-1,  9.D-1 /
       DATA XB / 1.D-7,  1.D-6,  1.D-5,  1.D-4,
     1           1.D-3,  1.D-2,
     2           1.D-1,  3.D-1,  5.D-1,  7.D-1,  9.D-1 /
*
* ---------------------------------------------------------------------
*
...
*
       OPEN(UNIT = 11, FILE = "../results/pegasus-table18-part3.csv",
     ,      STATUS = "REPLACE")
       WRITE(11, *) ",u_v,d_v,L_m,L_p,s_p,c_p,b_p,g"
...
*
  ...
  14     FORMAT (1PE6.0,1X,8(1PE11.3))
         END IF
  15     FORMAT(I2,8(",",E15.8))
         WRITE(11,15) K1 - 1, PDFX(1), -PDFX(2), -LMI, - 2D0 * LPL,
     ,        PDFX(-3), PDFX(-4), PDFX(-5), PDFX(0)
* 
   1    CONTINUE
   2   CONTINUE
       CLOSE(11)
