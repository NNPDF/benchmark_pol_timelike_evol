...
*
     ...
     2               + EBETA (E*1.5+PUV(2), PUV(3)+E) * (PUV(4) + 
     3               PUV(6) * (PUV(2)+ 1.5) / (PUV(2)+ PUV(3)+ 2.5)) )
       ADV = NDV * ( EBETA (PDV(2)+E, PDV(3)+E) *
     1               (1.+ PDV(5) * (PDV(2)+1.) / (PDV(2) + PDV(3)+ 2.))
     2               + EBETA (E*1.5+PDV(2), PDV(3)+E) * (PDV(4) + 
     3               PDV(6) * (PDV(2)+ 1.5) / (PDV(2)+ PDV(3)+ 2.5)) )
*
* --------------------------------------------------------------------- 
*
...
*
     ...
     1            * (E + EBETA (E*0.5+PSM(2), PSM(3)+E) * (PSM(4) +
...
*      
     ...
     2             + EBETA (E*1.5+PGL(2), PGL(3)+E) * (PGL(4) + 
