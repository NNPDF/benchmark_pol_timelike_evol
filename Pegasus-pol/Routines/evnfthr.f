...
* ---------------------------------------------------------------------
C=========================================================
c     LHA INITIALIZATION
c         name ="NNPDF40_nlo_as_01180"
cc         name ="NNPDF40_nlo_as_01180"
cc         name ="MSHT20nnlo_as118"         
...
*
       ...
       HQTHR = ASC2 * (A2SG(KN,3,1,1) * SGC3 + A2SG(KN,3,1,2) * GLC3)    
*
       M3C(KN)  = M3C3 * NSTHR
       M8C(KN)  = M8C3 * NSTHR
       VAC(KN)  = VAC3 * NSTHR
...
*
       ...
       GLC(KN) = GLC3 + ASC2* (A2SG(KN,3,2,1)* SGC3 
     1                + A2SG(KN,3,2,2)* GLC3)
*    
* ---------------------------------------------------------------------
*
...
*
       ...
       HQTHR = ASB2 * (A2SG(KN,4,1,1) * SGB4 + A2SG(KN,4,1,2) * GLB4)    
*
       M3B(KN)  = M3B4 * NSTHR
       M8B(KN)  = M8B4 * NSTHR
       M15B(KN) = M15B4 * NSTHR
...
*
       ...
       GLB(KN) = GLB4 + ASB2* (A2SG(KN,4,2,1)* SGB4 
     1                + A2SG(KN,4,2,2)* GLB4)
*    
* ---------------------------------------------------------------------
*
...
*
       ...
       HQTHR = AST2 * (A2SG(KN,5,1,1) * SGT5 + A2SG(KN,5,1,2) * GLT5)    
*
       M3T(KN)  = M3T5 * NSTHR
       M8T(KN)  = M8T5 * NSTHR
       M15T(KN) = M15T5 * NSTHR
...
*
       ...
       GLT(KN) = GLT5 + AST2* (A2SG(KN,5,2,1)* SGT5 
     1                + A2SG(KN,5,2,2)* GLT5)
*    
* ---------------------------------------------------------------------
*
  1    CONTINUE 
